...
export const InstagromApp = () => {
  ...
  const handleAddComment = async (e: FormData) => {
    const comment = e.get("post-message") as string;
    ...
    startTransition(async () => {
      ...
      //     ...prevComments,
      //     { id: lastId++, text: comment },
      //   ]);

      //! en caso de que el comentario no se envie, se restaura el estado anterior
  ...
  //   const comment = formData.get("post-message") as string;
